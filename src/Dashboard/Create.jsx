    ...
    return (
        <div ref={drag} className={`card  bg-base-100 relative p-4 ${isDragging? "opacity-25" :"opacity-100"}  shadow-md rounded-md cursor-grab`}>
            <div className="card-body">
                ...
                <button onClick={() => handelTaskDelete(task._id)} className="absolute bottom-1 right-8"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
